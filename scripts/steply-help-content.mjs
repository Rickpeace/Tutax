  ...
  // ═══════════════════════ Erste Schritte ═══════════════════════
  {
    ...
    steps: [
      ...
      { shot: "aussehen", target: "website",
        ...
        body: "Sie müssen nichts von Hand einstellen: Wählen Sie links „Von Ihrer Website“, geben Sie Ihre Website-Adresse ein und klicken Sie auf „Analysieren“. Die KI liest Farben, Schrift und Logo aus – zu helle Farben werden automatisch lesbar gemacht (Business)." },
      { shot: "aussehen", target: "modus",
        title: "Design-Grundlage wählen",
        body: "Links wählen Sie die Grundlage: „Steply-Standard“, „Von Ihrer Website“ oder „Nachgebaut“. Rechts sehen Sie sofort die Vorschau (Desktop oder Handy); mit „Auf Hilfe-Seite verwenden“ schalten Sie sie live." },
